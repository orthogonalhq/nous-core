...
[![CI](https://img.shields.io/github/actions/workflow/status/orthogonalhq/nous-core/ci-release.yml?branch=main&style=for-the-badge&label=CI)](https://github.com/orthogonalhq/nous-core/actions/workflows/ci-release.yml)
