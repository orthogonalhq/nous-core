  ...
  async run(input: AgentInput): Promise<AgentResult> {
    ...
    try {
      while (true) {
        ...
        // response to extract tool_use blocks — streaming drops them.
        ...
        // Conversational exit: if the model responded with no tool calls,
        // the turn is complete. This covers both normal text responses and
        // empty responses (model returned nothing). Without this, an empty
        // response with zero tool calls would loop forever.
