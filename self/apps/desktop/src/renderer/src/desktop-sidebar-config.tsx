...
import { Inbox, MessageSquare, Activity, ClipboardList } from 'lucide-react'

// --- Top nav items (static) ---

export const DESKTOP_TOP_NAV: SidebarTopNavItem[] = [
  { id: 'client-onboarding', label: 'Client onboarding', icon: <ClipboardList />, routeId: 'home' },
  { id: 'pulse', label: 'Pulse', icon: <Activity />, routeId: 'dashboard' },
