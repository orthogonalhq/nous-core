...
describe('shell type schemas', () => {
  ...
  it('parses valid ChatStage values and rejects invalid ones', () => {
    ...
    expect(ChatStageSchema.safeParse('large').success).toBe(true)
    expect(ChatStageSchema.safeParse('full').success).toBe(true)
    expect(ChatStageSchema.options).toEqual(['small', 'large', 'full'])
    expect(ChatStageSchema.safeParse('ambient_small').success).toBe(false)
    expect(ChatStageSchema.safeParse('ambient_large').success).toBe(false)
