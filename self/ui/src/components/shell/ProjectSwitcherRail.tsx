...
const styles = {
    root: {
        ...
        borderInlineEnd: '1px solid var(--nous-workspace-sidebar-border)',
    ...
    activeIndicator: {
        ...
        background: 'var(--nous-workspace-route-chip-fg)',
    },
    ghostIndicator: {
        position: 'absolute' as const,
        left: 0,
    ...
    homeButton: {
        ...
        border: '1px solid var(--nous-workspace-sidebar-border)',
