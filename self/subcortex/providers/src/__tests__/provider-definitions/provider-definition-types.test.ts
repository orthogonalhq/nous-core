...
type _ProviderVendorKeyIsExact = Expect<
  Equal<ProviderVendorKey, 'anthropic' | 'azure-openai' | 'codex-cli' | 'dashscope' | 'deepinfra' | 'gemini' | 'github-copilot-cli' | 'groq' | 'huggingface-tgi' | 'llama-cpp' | 'mistral' | 'moonshot' | 'openai' | 'ollama' | 'openclaw' | 'openrouter' | 'perplexity' | 'qwen-code' | 'together' | 'vllm' | 'xai'>
>;
type _BootstrapProviderKeyIsExact = Expect<
  Equal<BootstrapProviderKey, 'anthropic' | 'azure-openai' | 'codex-cli' | 'dashscope' | 'deepinfra' | 'gemini' | 'github-copilot-cli' | 'groq' | 'huggingface-tgi' | 'llama-cpp' | 'mistral' | 'moonshot' | 'openai' | 'ollama' | 'openclaw' | 'openrouter' | 'perplexity' | 'qwen-code' | 'together' | 'vllm' | 'xai'>
>;
