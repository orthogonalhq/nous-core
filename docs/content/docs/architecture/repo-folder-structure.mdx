...
├── web/                              # Chat UI + Projects UI + Dashboard + MAO projection
...
* Projects UI — workflow monitoring, canonical project dashboard, governed configuration, schedule settings, and project-scoped escalation queue acknowledgement
* Dashboard — system health, project status, memory inspection, and discovery projection
* MAO projection — forward-linked project control and agent visibility from workflow surfaces
