...
The structure is organized by the Mind Model — four layers of consciousness that mirror the architecture of the human mind. See [The Mind Model](/.architecture/the-mind-model) for the philosophical foundation.
...
See [Packages and Plugins](/.architecture/packages-and-plugins) for the full design.
