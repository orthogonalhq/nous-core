...
| `PKG-004-*` | Update/rollback outcome | `PKG-004-ROLLBACK_MIGRATION_FAILED` |
| `PKG-005-*` | Evidence completeness | `PKG-005-MISSING_WITNESS_REF` |
...
- **Lifecycle event schema** in `self/shared/src/types/package-lifecycle.ts`
