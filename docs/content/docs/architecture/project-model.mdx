...
## Workflow Definition and Runtime State (Phase 9.1)

Phase 9.1 adds the first canonical workflow-runtime contract layer for protocol and hybrid projects.
...
- **Workflow Engine** — Phase 9.1 establishes deterministic graph derivation, admission, and explicit run/node/dispatch lineage state; later phases add concrete node executors, scheduler integration, and artifact persistence
