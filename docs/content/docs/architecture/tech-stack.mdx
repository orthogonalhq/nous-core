...
tsdown is a fast, modern TypeScript bundler. oxlint and oxfmt are Rust-based alternatives to ESLint and Prettier — significantly faster for large codebases, with lower configuration overhead.
