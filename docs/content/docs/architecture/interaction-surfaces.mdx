...
5. User opens the **Marketplace Governance Surface** to inspect package trust posture, moderation status, or advisory suggestions
6. User follows into **Chat**, **Traces**, **Projects**, or **MAO** with preserved continuity context
7. Nous resumes execution only through the governed control path
