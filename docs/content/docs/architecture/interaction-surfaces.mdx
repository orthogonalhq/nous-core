...
4. User follows into the **Projects UI** to inspect the same run and node context, or into **Chat** for escalation follow-up
5. Nous resumes execution only through the governed control path
