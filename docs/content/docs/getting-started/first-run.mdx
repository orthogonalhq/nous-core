...
When you open the chat panel for the first time after finishing the wizard, the agent emits a one-shot welcome message in the personality preset you chose. The welcome appears as a normal agent message; nothing else about the chat looks different. See [Welcome Message (First Open)](/docs/guides/chat#welcome-message-first-open) for the full lifecycle and reset semantics.
