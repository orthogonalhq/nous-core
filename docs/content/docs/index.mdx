...
The name is deliberate. *Nous* is Greek for "mind" — the faculty of intellectual apprehension, the highest form of thinking. The architecture is modeled on the structure of human consciousness. See [The Mind Model](/docs/architecture/the-mind-model).
...
→ See: [Roadmap Overview](/docs/roadmap)
