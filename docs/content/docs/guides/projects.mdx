...
Phase 9.1 through Phase 9.5 now cover the canonical workflow foundation, ingress-backed scheduler dispatch, integrity-verified artifact persistence, and the first Projects UI monitoring/editor surface with linked Chat, Traces, and MAO projections. Later phases can refine authoring ergonomics and richer MAO/runtime supervision without changing the canonical truth model described here.
