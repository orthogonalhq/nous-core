...
Phase 9.1 and Phase 9.2 ship the canonical runtime foundation only. Later phases add broader scheduler-backed recurring execution, artifact persistence, richer Projects UI editing, and MAO projections over the run, wait, checkpoint, and correction state delivered here.
